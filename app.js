...
function handleDialogFlowAction(sender, action, messages, contexts, parameters) {
    if(action == 'details_application'){
        console.log("USER NAME= "+contexts[0].parameters.fields.user_name.stringValue);
        //sendEmail('new application', 'Thanks!');
        handleMessages(messages, sender);
    }
    else if(action == 'user_question'){
        console.log('you are here!!');
        sendTextMessage(sender, 'Its Nov 30 ');
    } else if (action == 'contact_info_admission'){
        handleMessages(messages, sender);
            sendTypingOn(sender);
            setTimeout(function() {
                let buttons = [
                    {
                        ...
                        title:"Check out Admission Website"
                    },
                    {
                        type:"phone_number",
                        title:"Call us",
                ...
                sendButtonMessage(sender, "Here is the information", buttons);
            }, 3000)
    }
    else 
    {
...
function receivedPostback(event) {
    ...
    switch (payload) {
        ...
        case 'ADMISSION_INFO':
            ...
            sendToDialogFlow(senderID, 'apply to cal poly pomona');
            break;
        case 'CHAT':
            //user wants to chat
